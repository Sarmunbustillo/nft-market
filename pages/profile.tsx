            ...
            <div className="h-full flex">
                <div className="flex-1 flex flex-col overflow-hidden">
                    <div className="flex-1 flex items-stretch overflow-hidden">
                                            ...
                                            >
                                                <div
                                                    className={classNames(
                                                        ...
                                                        'group block w-full aspect-w-10 aspect-h-7 rounded-full bg-gray-100 overflow-hidden'
                                                    )}
                                                >
                                                    <img
                                                        src={nft.meta.image}
                        ...
                        {/* Details sidebar */}
                        <aside className="hidden w-96 bg-white p-8 rounded-lg border-gray-200  lg:block shadow-lg">
                            {activeNft && (
